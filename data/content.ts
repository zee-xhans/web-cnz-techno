...
export const servicesData: ServiceItem[] = [
  {
    id: "ui-ux",
    slug: "ui-ux",
    title: "Desain UI/UX & Konversi",
    shortTitle: "Desain UI/UX & Konversi",
    navDesc: "Ubah pengunjung menjadi pembeli setia",
    subtitle: "Ubah pengunjung ragu menjadi pelanggan setia dengan alur transaksi instan.",
    shortDesc: "Desain antarmuka premium kelas dunia yang mempermudah proses transaksi dan melipatgandakan nilai konversi penjualan.",
    description:
      "Desain antarmuka premium kelas dunia yang mempermudah proses transaksi dan melipatgandakan nilai konversi penjualan.",
    longDescription:
      "Tampilan yang membingungkan membuat lebih dari 70% calon pembeli beralih ke kompetitor. Kami merekayasa ulang alur interaksi digital menggunakan psikologi keputusan pembeli agar proses transaksi berjalan cepat, meyakinkan, dan tanpa hambatan.",
    image:
    ...
    process: [
      { title: "1. Audit Kebocoran Konversi", desc: "Mendiagnosis mengapa calon pelanggan keluar tanpa membeli dan membedah kelemahan kompetitor." },
      { title: "2. Pemetaan Alur Cepat", desc: "Menghapus langkah rumit yang memperlambat keputusan beli pelanggan." },
      { title: "3. Visualisasi Kemewahan Brand", desc: "Menciptakan kesan eksklusif dan kredibilitas tinggi agar produk bernilai premium." },
      { title: "4. Pengujian Konversi Nyata", desc: "Memastikan setiap tombol, formulir, dan penawaran menghasilkan transaksi." },
    ],
    startingPrice: "Rp 12.000.000",
    estimatedTimeline: "3 - 5 Minggu",
    modules: [
      { title: "Landing Page Berdaya Pikat Tinggi", desc: "Halaman penawaran produk yang memicu rasa urgensi dan kepercayaan instan pembeli." },
      { title: "Arsitektur Checkout Cepat", desc: "Menghilangkan friksi pembayaran agar pembeli menyelesaikan transaksi tanpa ragu." },
      { title: "Dashboard & Portal Klien B2B", desc: "Portal interaktif yang mempermudah mitra memantau proyek, tagihan, dan repeat order." },
      { title: "Adaptasi Responsif Smartphone", desc: "Navigasi intuitif satu jempol di semua ukuran layar smartphone dan tablet." },
    ],
    faqs: [
  ...
  },
  {
    id: "web-dev",
    slug: "web-dev",
    title: "Platform Web & Otomasi Bisnis",
    shortTitle: "Website & Sistem Otomasi",
    navDesc: "Platform cepat, tangguh & siap skala",
    subtitle: "Sistem penjualan dan operasional otomatis 24 jam dengan performa kilat dan stabil.",
    shortDesc: "Platform website berkecepatan kilat (< 1 detik) siap menampung lonjakan pesanan, terhubung otomatis ke pembayaran dan WhatsApp.",
    description:
      "Platform website berkecepatan kilat (< 1 detik) siap menampung lonjakan pesanan, terhubung otomatis ke pembayaran dan WhatsApp.",
    longDescription:
      "Website yang lambat membuat calon pembeli beralih ke kompetitor. Kami membangun platform web dan sistem operasional bisnis terpadu yang memproses transaksi secara otomatis 24/7 dan tangguh menampung lonjakan trafik promo besar.",
    image:
    ...
    process: [
      { title: "1. Pemetaan Skema Bisnis", desc: "Menyesuaikan arsitektur sistem dengan alur operasional unik perusahaan Anda." },
      { title: "2. Pembangunan Mesin Web", desc: "Membangun antarmuka interaktif yang super cepat dan mudah dioperasikan." },
      { title: "3. Integrasi Pembayaran & Notifikasi", desc: "Menghubungkan pembayaran QRIS, Virtual Account, dan notifikasi WhatsApp." },
      { title: "4. Uji Beban & Peluncuran", desc: "Simulasi lonjakan ribuan pembeli serentak untuk menjamin keandalan server." },
    ],
    startingPrice: "Rp 18.000.000",
    estimatedTimeline: "4 - 8 Minggu",
    modules: [
      { title: "Toko Online & Portal Transaksi", desc: "Katalog belanja interaktif dan sistem filter produk instan tanpa reload halaman." },
      { title: "Otomasi Pembayaran & Faktur", desc: "Verifikasi pembayaran otomatis dalam hitungan detik dengan faktur digital terkirim instan." },
      { title: "Manajemen Stok & Laporan", desc: "Dashboard kendali lengkap untuk memantau omset, sisa inventori, dan data pelanggan." },
      { title: "Integrasi Ekspedisi Logistik", desc: "Hitung ongkos kirim otomatis dan kirim nomor resi pelacakan secara mandiri." },
    ],
    faqs: [
  ...
  },
  {
    ...
    shortTitle: "Aplikasi Mobile (iOS & Android)",
    navDesc: "Kuasai layar pelanggan & repeat order",
    subtitle: "Kuasai layar utama pelanggan dan maksimalkan angka pembelian berulang.",
    shortDesc: "Aplikasi mobile resmi di App Store & Play Store untuk mengunci loyalitas pelanggan, siaran promo gratis, dan pembayaran sekali sentuh.",
    description:
      "Aplikasi mobile resmi di App Store & Play Store untuk mengunci loyalitas pelanggan, siaran promo gratis, dan pembayaran sekali sentuh.",
    longDescription:
      "Smartphone adalah perangkat paling sering diakses konsumen setiap hari. Kami menghadirkan aplikasi mobile profesional dengan sistem loyalitas terintegrasi, pembayaran biometrik, dan push notification promo gratis tanpa biaya iklan.",
    image:
    ...
    process: [
      { title: "1. Strategi Retensi Mobile", desc: "Merancang skema reward dan navigasi belanja yang memikat loyalitas pengguna." },
      { title: "2. Pembangunan Aplikasi Native/Cross", desc: "Aplikasi responsif dengan animasi ringan dan performa mulus di semua smartphone." },
      { title: "3. Integrasi Pembayaran & Push Notification", desc: "Menghubungkan gerbang pembayaran instan dan sistem push notification promo." },
      { title: "4. Penerbitan di App Store & Play Store", desc: "Pengawalan lengkap proses verifikasi hingga aplikasi resmi terbit untuk publik." },
    ],
    startingPrice: "Rp 25.000.000",
    estimatedTimeline: "6 - 12 Minggu",
    modules: [
      { title: "Etalase & Pencarian Interaktif", desc: "Katalog belanja berkecepatan tinggi dengan filter kategori cerdas." },
      { title: "Program Member & Poin Loyalitas", desc: "Skema loyalitas bertingkat yang memotivasi pelanggan untuk terus bertransaksi." },
      { title: "Checkout Biometrik Satu Sentuhan", desc: "Kemudahan transaksi menggunakan Face ID, sidik jari, dan e-wallet lokal." },
      { title: "Pusat Broadcast Notifikasi Promo", desc: "Kirim pesan penawaran terbatas langsung ke layar depan ribuan pelanggan serentak." },
    ],
    faqs: [
  ...
  },
  {
    ...
    title: "SEO & Pertumbuhan Organik",
    shortTitle: "SEO & Pertumbuhan Organik",
    navDesc: "Dominasi Google & banjir pembeli aktif",
    subtitle: "Banjiri bisnis dengan prospek aktif dari Google tanpa biaya iklan berbayar.",
    shortDesc: "Strategi ranking #1 Google untuk mendatangkan prospek berkualitas tinggi yang siap bertransaksi setiap hari.",
    description:
      "Strategi ranking #1 Google untuk mendatangkan prospek berkualitas tinggi yang siap bertransaksi setiap hari.",
    longDescription:
      "Iklan berbayar terus meningkat biayanya dan berhenti menghasilkan saat saldo habis. Kami menempatkan bisnis Anda di peringkat teratas Google untuk kata kunci bernilai transaksi tinggi, menciptakan aliran prospek organik berkelanjutan.",
    image:
    ...
    process: [
      { title: "1. Riset Kata Kunci Profit", desc: "Mencari kata kunci berniat beli tinggi yang sering diketik oleh calon pembeli produk/jasa Anda." },
      { title: "2. Optimasi Teknis Google", desc: "Memperbaiki kecepatan dan struktur teknis website agar diprioritaskan oleh algoritma Google." },
      { title: "3. Penerbitan Konten Otoritas", desc: "Menyusun konten informatif yang mengarahkan pengunjung langsung ke kontak penjualan." },
      { title: "4. Evaluasi & Pertumbuhan Prospek", desc: "Pemantauan rutin posisi ranking dan volume prospek transaksi yang dihasilkan." },
    ],
    startingPrice: "Rp 8.000.000 / bln",
    estimatedTimeline: "Retainer Bulanan / 4 Minggu Audit",
    modules: [
      { title: "Riset Kata Kunci Profit", desc: "Menargetkan pencarian dengan niat beli tertinggi di industri Anda." },
      { title: "Technical SEO & Core Web Vitals", desc: "Memastikan website memuat instan agar Google menempatkannya di ranking teratas." },
      { title: "Halaman Solusi Otoritas Tinggi", desc: "Konten berbobot yang meyakinkan pengunjung untuk segera menghubungi tim Anda." },
      { title: "Pelacakan Ranking & Konversi", desc: "Laporan berkala performa peringkat kata kunci dan pertumbuhan calon pembeli." },
    ],
    faqs: [
...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    tierNumber: "TIER 1",
    name: "STARTER",
    badge: "Fase Uji Coba Cepat",
    description: "Fase Uji Coba Cepat. Solusi kilat untuk UMKM yang ingin segera hadir di internet tanpa risiko.",
    monthlyPrice: "Rp 540.000",
    annualPrice: "Rp 540.000",
    popular: false,
    ctaText: "Pilih Paket Starter",
    features: [
      {
        title: "Gratis Domain .com (1 Tahun)",
        impact: "Brand Anda langsung diakui dan terlihat bonafide tanpa biaya tersembunyi.",
      },
      {
        title: "1 Landing Page Premium",
        impact: "Desain berbasis psikologi marketing untuk mengubah pengunjung dari sosmed menjadi pembeli.",
      },
      {
        title: "Tombol Auto-Order WA",
        impact: "Pelanggan bisa langsung transaksi dalam 1x klik tanpa alur yang ribet.",
      },
      {
        title: "Setup Kilat 24 Jam",
        impact: "Eksekusi cepat, bisnis Anda siap jualan online mulai besok pagi.",
      },
    ],
  },
  {
    ...
    tierNumber: "TIER 2",
    name: "ESSENTIAL",
    badge: "Membangun Otoritas Brand",
    priceNote: "Jarak 350rb dari Starter",
    description: "Membangun Otoritas Brand. Tampil meyakinkan dan kalahkan kompetitor yang masih memakai web gratisan.",
    monthlyPrice: "Rp 890.000",
    annualPrice: "Rp 890.000",
    popular: false,
    ctaText: "Pilih Paket Essential",
    features: [
      {
        title: "Struktur Web 3 Halaman",
        impact: "(Home, Layanan, Profil). Membangun kepercayaan mutlak dan meyakinkan calon klien kelas atas.",
      },
      {
        title: "Email Bisnis Profesional",
        impact: "(Contoh: halo@bisnisanda.com). Tingkatkan tingkat kepercayaan 10x lipat dibanding email Gmail biasa.",
      },
      {
        title: "Optimasi SEO Dasar",
        impact: "Mulai ditemukan oleh pelanggan potensial yang mencari produk Anda di Google.",
      },
      {
        title: "Fast Load Optimized",
        impact: "Bebas loading lambat yang sering bikin calon pelanggan kabur sebelum membaca penawaran.",
      },
    ],
  },
  {
    ...
    priceNote: "Jarak 600rb dari Essential",
    description: "Mesin Otomatisasi Sales. Sistem cerdas yang bekerja 24/7 untuk bisnis yang siap scale-up.",
    monthlyPrice: "Rp 1.490.000",
    annualPrice: "Rp 1.490.000",
    popular: true,
    ctaText: "Pilih Paket Growth",
    features: [
      {
        title: "Formulir Order Cerdas (API)",
        impact: "Sistem menerima pesanan dan mencatat data otomatis 24 jam penuh, meskipun admin Anda sedang tidur.",
      },
      {
        title: "Akses Dashboard Mandiri",
        impact: "Kendali penuh di tangan Anda. Ubah teks, harga, atau gambar kapan saja tanpa perlu bayar jasa update.",
      },
      {
        title: "Maksimal 7 Halaman",
        impact: "Ruang luas dan terstruktur untuk memamerkan seluruh katalog produk dan edukasi market secara mendalam.",
      },
      {
        title: "Google Analytics Setup",
        impact: "Lacak asal pengunjung dan pantau produk terlaris untuk menghemat biaya iklan (Ads) Anda.",
      },
    ],
  },
  {
    ...
    tierNumber: "TIER 4",
    name: "ENTERPRISE",
    badge: "Infrastruktur Tanpa Batas",
    description: "Infrastruktur Tanpa Batas. Rekayasa software kustom eksklusif untuk korporasi dan skala industri.",
    monthlyPrice: "Mulai Rp 2.940.000",
    annualPrice: "Mulai Rp 2.940.000",
    popular: false,
    ctaText: "Pilih Paket Enterprise",
    features: [
      {
        title: "Sistem Bayar Otomatis (Payment Gateway)",
        impact: "Terima pembayaran via BCA, Mandiri, OVO, CC. Transaksi tervalidasi seketika tanpa perlu cek mutasi manual.",
      },
      {
        title: "Rekayasa Database Custom",
        impact: "Dashboard admin dan sistem inventori khusus yang dirancang mengikuti alur kerja (workflow) spesifik perusahaan Anda.",
      },
      {
        title: "Halaman Web Unlimited",
        impact: "Skalabilitas tanpa batas. Siap menampung ribuan artikel, produk, maupun traffic tinggi.",
      },
      {
        title: "Priority Support 24/7",
        impact: "Jalur komunikasi VIP (Prioritas). Tim engineer kami siap menjaga keamanan dan performa aset digital Anda setiap saat.",
      },
    ],
  },
];
